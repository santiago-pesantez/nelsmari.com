    ...
    container.innerHTML = `
      <div class="pd-layout">
        ...
        <div class="pd-info">
          ...
          <!-- Quick WhatsApp -->
          <a href="${typeof Config !== 'undefined' ? Config.WHATSAPP_URL : 'https://wa.me/593979316659'}?text=${encodeURIComponent(`Hola Nelsmari, quiero pedir: ${product.nombre} ($${price.toFixed(2)})`)}"
